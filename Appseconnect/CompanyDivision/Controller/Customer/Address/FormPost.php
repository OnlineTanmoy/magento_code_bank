<?php
namespace Appseconnect\CompanyDivision\Controller\Customer\Address;
 ...
 */
class FormPost extends \Appseconnect\B2BMage\Controller\Customer\Address\FormPost
{
    /**
     * Region
     *
    ...
    private function _extractCustomerAddress()
    {
        ...
        if ($this->helperContactPerson->isContactPerson(
            ...
            if ($this->_getSession()->getCurrentCustomerId()) {
                $customerId = $this->_getSession()->getCurrentCustomerId();
            } else {
