 ...
 */
namespace Appseconnect\CompanyDivision\Model\ResourceModel\Division;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init(
            'Appseconnect\CompanyDivision\Model\Division',
            'Appseconnect\CompanyDivision\Model\ResourceModel\Division'
        );
    ...
    public function contactFilter($collection, $customerId)
    {
        ...
        $collection->getSelect()
            ...
            ->join(
                [
                'customer' => $this->_resources->getTableName('insync_division')
                ], 'e.entity_id = customer.division_id', [
                'division_id' => 'id'
                ]
            );
        return $collection;
