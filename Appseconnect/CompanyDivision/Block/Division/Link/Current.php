 ...
 */
namespace Appseconnect\CompanyDivision\Block\Division\Link;
...
class Current extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $isParent = $this->helper->isParentContact($this->customerSession->getCustomerId());
        if (false != $this->getTemplate() || $isParent != 1) {
