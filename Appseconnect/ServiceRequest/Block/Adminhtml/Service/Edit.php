...
namespace Appseconnect\ServiceRequest\Block\Adminhtml\Service;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    public function getHeaderText()
    {
        if ($this->coreRegistry->registry('insync_servicerequest')->getId()) {
            return __("Edit Service Request '%1'", $this->escapeHtml($this->coreRegistry->registry('insync_servicerequest')
                ->getTitle()));
        } else {
