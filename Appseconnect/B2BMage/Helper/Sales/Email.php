...
class Email extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function yourCustomMailSendMethod(
        ...
        try {
            if ($action == 'approved') {
                $templateID = $this->scopeConfig->getValue('insync_approver/email/order_success', 'store');
            } elseif ($action == 'cancel') {
                $templateID = $this->scopeConfig->getValue('insync_approver/email/order_cancel', 'store');
            } elseif ($action == 'approval_start') {
                $templateID = $this->scopeConfig->getValue('insync_approver/email/type', 'store');
            }
