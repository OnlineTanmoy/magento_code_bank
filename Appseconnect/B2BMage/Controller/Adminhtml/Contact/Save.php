...
class Save extends \Magento\Customer\Controller\Adminhtml\Index\Save
{
    ...
    public function execute()
    {
        ...
        if ($originalRequestData) {
            try {
                ...
                $contactPersonId = $this->_processContactPerson($isExistingCustomer, $customer, $contactPersonId);

                $this->_saveSoldToAddress($customer, $contactPersonId);
                ...
                $this->_saveContactPersonMapping($originalRequestData, $customerId, $contactPersonId, $entityId);
     ...
     * @return int
     */
    private function _processContactPerson($isExistingCustomer, $customer, $contactPersonId)
    {
        if ($isExistingCustomer) {
     ...
     * @return void
     */
    private function _saveSoldToAddress($customer, $contactPersonId)
    {
     ...
     * @return void
     */
    private function _saveContactPersonMapping($originalRequestData, $customerId, $contactPersonId, $entityId)
    {
        $contactPersonData = [];
