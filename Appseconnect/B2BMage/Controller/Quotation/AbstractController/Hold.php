 ...
 * @link     https://www.appseconnect.com/
 */
abstract class Hold extends Action\Action
{
    ...
    public function execute()
    {
        ...
        try {
            $this->quotationService->holdQuoteById($quoteId);
            $this->messageManager->addSuccess(__('You have successfully holded the quote.'));
        } catch (\Exception $e) {
            $this->messageManager->addException(
                $e,
                __('Something went wrong while holding the quote.')
            );
        }
