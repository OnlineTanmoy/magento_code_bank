 ...
 */
namespace Appseconnect\B2BMage\Model\ResourceModel\Customer\Grid;
...
class Collection extends \Magento\Framework\View\Element\UiComponent\DataProvider\SearchResult
{
    ...
    public function __construct(
        ...
        $mainTable = 'insync_customer_specialprice',
        $resourceModel = \Appseconnect\B2BMage\Model\ResourceModel\Customer::class
    ) {
