...
namespace Appseconnect\B2BMage\Model\ResourceModel\Product\Grid;
...
class Collection extends \Magento\Framework\View\Element\UiComponent\DataProvider\SearchResult
{
    ...
    public function __construct(
        ...
        $mainTable = 'insync_customer_tierprice',
        $resourceModel = \Appseconnect\B2BMage\Model\ResourceModel\Product::class
    ) {
