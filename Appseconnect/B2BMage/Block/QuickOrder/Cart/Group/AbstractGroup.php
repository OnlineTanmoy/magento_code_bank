 ...
 */
namespace Appseconnect\B2BMage\Block\QuickOrder\Cart\Group;
...
abstract class AbstractGroup extends Widget implements RendererInterface
{
     ...
     *
     * @param int|null $groupId gorupo id
     *
     * @return array|string
     */
    public function getCustomerGroups($groupId = null)
    {
        if ($this->customerGroups === null) {
            ...
            $this->customerGroups = $this->getInitialCustomerGroups();
     ...
     * Retrieve customized price column header
     *
     * @param string $defaultValue defaulot value
     *
     * @return string
     */
