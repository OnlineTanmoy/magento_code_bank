...
class CustomerOrder implements ResolverInterface
{
     ...
     */
    private function getSalesData(string $customer_email): array
    {
        try {
            /* filter for all customer orders */
            $searchCriteria = $this->searchCriteriaBuilder->addFilter('customer_email', $customer_email,'eq')->create();
            ...
            foreach($orders as $order) {
                ...
                $salesOrder['allOrderRecords'][$orderId]['status'] = $order->getStatus();
