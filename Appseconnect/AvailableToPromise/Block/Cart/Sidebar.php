...
namespace Appseconnect\AvailableToPromise\Block\Cart;
...
class Sidebar extends \Magento\Checkout\Block\Cart\Sidebar
{
     ...
     */
    public $availableToPromiseHelper;
    ...
    public function __construct(
        ...
        \Appseconnect\AvailableToPromise\Helper\DeliveryDate\Data $availableToPromiseHelper,
        ...
        $this->availableToPromiseHelper = $availableToPromiseHelper;
    ...
    public function getConfig()
    {
        ...
        $var['ismaxQuantity'] = $this->isDisable();
    ...
    {
        return $this->availableToPromiseHelper->isDisable();
    }
